...
function Editconsultas() {
    ...
    const uploadConsultas = async () => {
        ...
        const response = await axios.post("http://127.0.0.1:8000/api/consultasupdate/" + id, formData, {
    ...
    const getConsultas = useCallback(() => {
        axios.get('http://127.0.0.1:8000/api/consultas/' + id).then(function (response) {
            console.log(response);
            setInputs(response.data.consultas);
        });
    }, [id]);
                    ...
                    <div className="col-md-8 mt-4">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3 row">
                                ...
                                <div className="col-sm-9">
                                    <input type="text" value={inputs.data} className="form-control" name="description" onChange={handleChange} />
                                </div>
                            </div>
